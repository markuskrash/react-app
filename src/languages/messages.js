...
export const messages = {
  ...
  [LOCALES.RUSSIAN]: {
    ...
    about_hide: 'Нажав на эту кнопку вы можете скрыть свой ответ на вопрос',
    hide_teacher:'Вы скрыли ответ на данный вопрос, чтобы открыть его, нажмите на соответсвующую кнопку.',
