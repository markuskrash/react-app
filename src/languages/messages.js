...
export const messages = {
  ...
  [LOCALES.RUSSIAN]: {
    ...
    search: 'Поиск',
    to_search: 'Найти',
    about_search: 'Введя здесь текст и нажав на кнопку поиска, вы можете найти заданный вами вопрос или публичный вопрос другого пользователя.',
    about_ask: 'Нажав сюда, вы сможете задать вопрос одному из преподавателей лицея.',
    about_welcome: 'Добро пожаловать,',
    about_student:'Здесь вы можете задать вопрос любому учителю и получить на него ответ.',
    about_teacher:'Здесь вы можете отвечать на вопросы учеников и редактровать свои ответы.',
  }
}